...
\index{Student@{Student}!Student@{Student}}
\index{Student@{Student}!Student@{Student}}
\subsubsection[{\texorpdfstring{Student(std\+::string, std\+::string, int)}{Student(std::string, std::string, int)}}]{\setlength{\rightskip}{0pt plus 5cm}Student\+::\+Student (
\begin{DoxyParamCaption}
\item[{std\+::string}]{user, }
\item[{std\+::string}]{college, }
\item[{int}]{password}
\end{DoxyParamCaption}
)}\hypertarget{classStudent_ae0f9f843d8276e9cc7736c6b0118a62d}{}\label{classStudent_ae0f9f843d8276e9cc7736c6b0118a62d}
